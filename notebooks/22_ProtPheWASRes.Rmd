---
title: An R Markdown document converted from "22_ProtPheWASRes.ipynb"
output: html_document
---

# Results of PheWAS - Proteins
...
```{r}
write_tsv(protphewas, "../data/protphewas.tsv")
```
...
```{r}
write_tsv(protmeta, "../data/protmeta.tsv")
```
